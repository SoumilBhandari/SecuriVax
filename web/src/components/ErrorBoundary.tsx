...
export class ErrorBoundary extends Component<
  { children: ReactNode; label?: string; page?: boolean; fallback?: ReactNode; onError?: () => void },
  { failed: boolean }
> {
  state = { failed: false };
  ...
  render() {
    ...
    // A section with something of its own to show instead: the landing
    // chapters fall back to their flat drawing, where a notice would sit over
