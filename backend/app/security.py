...
live_limit = RateLimit("live request", 6)
sign_in_limit = RateLimit("sign-in", 10)
sign_up_limit = RateLimit("sign-up", 5)
ALL_LIMITS = (explain_limit, agent_limit, agent_hourly_limit, vvm_limit, plan_limit, live_limit, sign_in_limit, sign_up_limit)
