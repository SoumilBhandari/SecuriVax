...
| --- | --- | --- |
| `ui-overhaul.md` | The design contract for the September UI overhaul: type, colour, motion, the chapter structure. | Mostly. The hero no longer carries two live chips, there are four nav tabs rather than five, and the landing nav has two links. Its note about swapping SF Pro for a system stack before going public has been done. |
